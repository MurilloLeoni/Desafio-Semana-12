const Qualities = () => {
  return (
    ...
    <div className='flex items-center'>
        <img className='w-10 h-10 md:w-14 md:h-14' src="/src/assets/icons/Icon-trophy.png" alt="Trophy" />
        <div className='ml-2'>
    ...
    <div className='flex items-center'>
        <img className='w-10 h-10 md:w-14 md:h-14' src="/src/assets/icons/Icon-guarantee.png" alt="Guarantee" />
        <div className='ml-2'>
    ...
    <div className='flex items-center'>
        <img className='w-10 h-10 md:w-14 md:h-14' src="/src/assets/icons/Icon-shipping.png" alt="Shipping" />
        <div className='ml-2'>
    ...
    <div className='flex items-center'>
        <img className='w-10 h-10 md:w-14 md:h-14' src="/src/assets/icons/Icon-support.png" alt="Support" />
        <div className='ml-2'>
