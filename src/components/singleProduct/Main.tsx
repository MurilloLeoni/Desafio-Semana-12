...
const Main = ({
  ...
  return (
    <div className="px-4 md:px-24 py-11">
      <div className="flex flex-col md:flex-row gap-8 md:gap-20 text-justify">
        ...
        <img
          className="w-full md:w-[460px] md:h-[500px] object-cover"
          src={selectedImage}
          alt="ImagemPrincipal"
        />
        <div className="flex flex-col gap-4 w-full md:w-96">
          <h1 className="text-2xl md:text-4xl text-left">{title}</h1>
          <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-start md:items-center">
            <h4 className="text-#9F9F9F font-medium text-xl md:text-2xl">
              Rp. {salePrice}
            </h4>
            <h4 className="line-through font-medium text-sm md:text-base">
              Rp. {normalPrice}
            </h4>
          </div>
          <p>{rating} Rating</p>
          ...
          <h6 className="text-lg md:text-xl">Size</h6>
          ...
          <h6 className="text-lg md:text-xl text-#9F9F9F">Color</h6>
          <div className="flex flex-wrap gap-2 md:gap-4">
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            ...
            <button
              ...
              className="border border-black px-12 py-4 rounded-2xl text-center"
            >
              Add to cart
            </button>
          </div>
          ...
          <div className="text-#9F9F9F flex flex-col gap-3 mt-6">
            <h6>
              SKU <span className="ml-2">:</span> {sku}
            </h6>
            <h6>
              Category<span className="ml-2">:</span> {category}
            </h6>
            <h6>
              Tags<span className="ml-2">:</span> {tags.join(", ")}
            </h6>
