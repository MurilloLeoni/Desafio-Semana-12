...
const Banner = () => {
  return (
    ...
    <img className='hidden md:block w-full h-full' src="/src/assets/imgs/Banner-home.png" alt="Banner" />
    <div className='md:absolute bg-#FFF3E3 rounded-xl font-poppins w-full md:w-[620px] md:top-[52%] md:left-[71.5%] md:-translate-x-1/2 md:-translate-y-1/2 text-left px-6 md:px-[40px] pt-8 md:pt-16 pb-6 md:pb-10 flex flex-col gap-4 md:gap-6'>
